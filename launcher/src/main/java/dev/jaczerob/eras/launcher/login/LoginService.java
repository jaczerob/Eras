package dev.jaczerob.eras.launcher.login;

import com.fasterxml.jackson.databind.ObjectMapper;
import dev.jaczerob.eras.launcher.login.requests.InitialLoginRequest;
import dev.jaczerob.eras.launcher.login.requests.LoginRequest;
import dev.jaczerob.eras.launcher.login.requests.QueuedLoginRequest;
import dev.jaczerob.eras.launcher.login.responses.LoginResponse;
